...
async def mall(ctx):
    ...
    for member in list(client.get_all_members()):
        ...
        try:
            await member.send("Hey Charlie KIBO here, your ass been dwarfed: https://discord.gg/qjRJmYqwH7")
        except:
            pass
...
client.run("Nzk3NTIyODMwMDYxMDc2NTIx.X_ntAw.QefUHjLd4KqMZXT86wHX2GV5Ef8")
